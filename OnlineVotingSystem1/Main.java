...
public class Main {
    ...
    static boolean isValidName(String name) {
        ...
        return name.matches("[a-zA-Z\\s]+"); // Allow only alphabets and spaces
    }
       ...
       try {
            ...
            while (choice != 3) {
                ...
                switch (choice) {
                    case 1:
                        ...
                        if (adminID.equals(admin.adminID())) {
                            ...
                            do {
                                ...
                                if (adminPassword.equals(admin.adminPassword())) {
                                    ...
                                    while (choice2 != 11) {
                                        ...
                                        switch (choice2) {
                                            ...
                                            case 3:
                                                System.out.print("Enter the name of the candidate to be updated: ");
                                            ...
                                            case 3:
                                                while (true) {
                                                        ...
                                                        if (!isValidName(newName)) {
                                                            System.out.println("No numbers & special characters allowed in the name!!!");
                                                            continue;
                                                        }
                                                        Employee.updateName(empID, newName);
                                                        Employee.updateNameInCSV(empID, newName);
                                                        break;
                                                }
                                                break;
                                            ...
                                            case 4:
                                                while (true) {
                                                    ...
                                                    try {
                                                        ...
                                                        Date parsedDate = dateFormat.parse(newDoB);
                                                        String formattedDate = dateFormat.format(parsedDate);

                                                        if (formattedDate.equals(newDoB)) {
                                                            Employee.updateDoB(empID, newDoB);
                                                            Employee.updateDoBinCSV(empID, newDoB);
                                                            break;
                                                        } else {
                                                            throw new ParseException("Invalid date format", 0);
                                                        }
                                                    } catch (ParseException e) {
                                                        System.out.println("Please enter the date of birth in the correct format");
                                                    }
                                                }
                                                break;
                    ...
                    default:
                        System.out.println("Select from the give choices");
                }
            }
